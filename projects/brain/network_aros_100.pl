...
J_101_n_NT :: glunv + 63*nae + 58*kn -> glue + 63*nan + 58*ke  	; from Attwell&Laughlin budget (affects vcyc vs jpdhn slope)
...
J_411_n_LDH :: pyrnc + nadhnc = lacn + nadnc		
J_511_a_LDH :: pyrac + nadhac = laca + nadac		
...
J_900_a_OP :: 2*nadham + 5*adpa + o2a -> 2*nadam + 5*atpa + 0.100*rosa		; ROS production (increasing this decreases ogi)
